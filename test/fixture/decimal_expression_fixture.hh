...
namespace Parametric {
    ...
    */
    struct DataParametricDecimalExpressionFixture {
        DataParametricTA automaton;
        std::unique_ptr<Signature> signature;
        DataParametricDecimalExpressionFixture() {
    ...
    */
    struct ParametricDecimalExpressionFixture {
        ParametricTA automaton;
        std::unique_ptr<Signature> signature;
        ParametricDecimalExpressionFixture() {
            using namespace Symbolic;
            using namespace Parma_Polyhedra_Library;
