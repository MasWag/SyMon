...
#include "fixture/decimal_expression_fixture.hh"
...
BOOST_AUTO_TEST_SUITE(ParametricMonitorTest)
  ...
  BOOST_FIXTURE_TEST_CASE(decimal_test, ParametricMonitorFixture) {
    auto automaton = Parametric::ParametricDecimalExpressionFixture().automaton;
