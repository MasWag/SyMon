...
template <typename StringConstraint, typename NumberConstraint, typename TimingConstraint, typename Update>
struct AutomatonTransition<
    StringConstraint, NumberConstraint, TimingConstraint, Update,
...
struct AutomatonState {
  ...
  AutomatonState(
      ...
      const boost::unordered_map<
          Action, std::vector<AutomatonTransition<StringConstraint, NumberConstraint, TimingConstraint, Update>>> &next)
...
struct TimedAutomaton<StringConstraint, NumberConstraint, ParametricTimingConstraint, Update>
  ...
  TimedAutomaton<StringConstraint, NumberConstraint, ParametricTimingConstraint, Update> deepCopy() const {
    using BaseAutomaton =
        Automaton<AutomatonState<StringConstraint, NumberConstraint, ParametricTimingConstraint, Update>>;
...
using NonParametricTA = TimedAutomaton<NonSymbolic::StringConstraint, NonSymbolic::NumberConstraint<Number>,
                                       std::vector<TimingConstraint<Time>>, NonSymbolic::Update<Number>>;
template <typename Number, typename Time>
...
using DataParametricTA = TimedAutomaton<Symbolic::StringConstraint, Symbolic::NumberConstraint,
                                        std::vector<TimingConstraint<Time>>, Symbolic::Update>;
template<typename Time>
...
using ParametricTA = TimedAutomaton<Symbolic::StringConstraint, Symbolic::NumberConstraint, ParametricTimingConstraint,
                                    Symbolic::Update>;
using PTAState = AutomatonState<Symbolic::StringConstraint, Symbolic::NumberConstraint, ParametricTimingConstraint,
                                Symbolic::Update>;
